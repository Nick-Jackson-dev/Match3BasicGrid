...
function LoseState(layer) {
    powerupjs.GameObjectList.call(this, layer);

    // the background
    this.background = new powerupjs.SpriteGameObject(sprites.temp_lose_overlay);
...
LoseState.prototype = Object.create(powerupjs.GameObjectList.prototype);
