...
function WinState(layer) {
    powerupjs.GameObjectList.call(this, layer);

    // the background
    this.background = new powerupjs.SpriteGameObject(sprites.temp_win_overlay);
...
WinState.prototype = Object.create(powerupjs.GameObjectList.prototype);
